          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <> hi : {alldata[0].toNumber()} </>
             <> CentralApproved : {alldata[0].toNumber()}</> 
              <> CentralRejected {CentralRejected = alldata[1].toNumber()}</> 
              <> TotalRequest  {TotalRequest = alldata[2].toNumber()}</> 
              <> ToatlRejected  {ToatlRejected = alldata[3].toNumber()}</> 
              <> CentralRequest  {CentralRequest = alldata[4].toNumber()}</> 
              <> CentralTotal {CentralTotal = alldata[5].toNumber()}</>
            </p>
