        ...
        <div className="flex items-center min-h-screen px-4 py-8">
          ...
          {singleShipmentData == undefined ?(
            ...
            <div className="text-left">
              <p> Your Request has been Rejected Due to</p>
              <p>Request Date: {converTime(singleShipmentData.Req_Date)}</p>
              <p>From: {singleShipmentData.from}</p>
              <p>status: {singleShipmentData.status}</p>
              <p>Price: {singleShipmentData.amount}</p>
              <p>Paid:{''} {singleShipmentData.feedback ? 'Complete' : "Not Complete"}</p>
