...
export default ({getModel, setGetModel, getFund,allShipmentsdata,startModel,setStartModel,startFund,RejectedFund}) => {
    ...
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="fixed inset-0 w-full h-full bg-black opacity-40" onClick={()=> setGetModel(false)}>
        ...
        <div className="flex items-center min-h-screen px-4 py-8">
          ...
          <button onClick={()=> setRejectFund(true)} className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-red-600
