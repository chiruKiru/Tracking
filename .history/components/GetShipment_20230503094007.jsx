        ...
        <div className="flex items-center min-h-screen px-4 py-8">
          ...
          {singleShipmentData == undefined ?(
            ...
            <div className="text-left">
              ...
              <p>Sender: {singleShipmentData.pickupTime}</p>
              <p>Sender: {singleShipmentData.deliveryTime}</p>
              <p>Sender: {singleShipmentData.distance}</p>
              <p>Sender: {singleShipmentData.price}</p>
              <p>Sender: {singleShipmentData.sender.slice(0,25)}...</p>
              <p>Sender: {singleShipmentData.sender.slice(0,25)}...</p>
              <p>Sender: {singleShipmentData.sender.slice(0,25)}...</p>
              <p> Paid:{''} {singleShipmentData.isPaid ? 'Complete' : }</p>
              </div>
          )
          }
