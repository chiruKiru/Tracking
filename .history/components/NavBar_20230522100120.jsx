...
import { Nav1,Nav2,Nav3,purple } from "./index";
...
export default() => {
  ...
  return (
    <nav className={`bg-[url('/img/hero-pattern.svg')] md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0 ": " "}`}>
      <div className="gap-x-14 items-center mx-w-screen-xl mx-auto px-4 md:flex md:px-8">
        <div className="flex items-center justify-between py-3 md:py-5 md:block">
        <a href="/">
          <img src='../Images/logo.png' width={120} height={50} alt="logo" />
        </a>
