...
export default ({
    ...
    useEffect(() => {
      const fetchETHRate = async () => {
        try {
          ...
          const rate = data.ethereum.data.ethereum.inr;;
          setEthRate(rate);
        } catch (error) {
  ...
  return (
          ...
          <form id='Data'onSubmit={(e)=> {e.preventDefault()}}>
            ...
            <input id="q" type="text" name="q" className={mass} value={request.ReqDate} onChange={()=>""}/>
              ...
              <input
                ...
                onChange={(e)=> setRequest({ ...request, amount: e.target.value/135000,})}/>
                </div>
                <div className="relative mt-5">
          ...
          <div className="relative mt-5">
          <button onClick={console.log(request.amount)} className='bg-indigo-900 text-white hover:bg-blue-400 font-bold py-2 px-4 mt-3 rounded items-center'>
            Request Funds
          </button>
          </div>
          </form> 
