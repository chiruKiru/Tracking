    ...
    <>
          ...
          <form onSubmit={(e)=> {e.preventDefault(); onSubmitHandler}}>
            ...
            <div className="relative mt-3">
              ...
              {ipfs && (
                <>
                    <input type="file" name="file" onChange={(e)=> setShipment({ ...shipment, image: e.target.value,})onSubmitHandler}/>
                </>
              )}
              <div>
          ...
          <button type='submit' className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-indigo-600
