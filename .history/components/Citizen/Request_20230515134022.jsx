...
const {onSubmitHandler} = useContext(TransactionContext)
...
export default ({
  ...
  return (
    <>
          ...
          <button onClick={()=>{createItem(); onSubmitHandler; form.reset();}} className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-indigo-600
