...
export default ({
  ...
  return (
          ...
          <div className="relative mt-5">
      <button onClick={convertEtherToRupees,console.log(amou\)} className='bg-indigo-900 text-white hover:bg-blue-400 font-bold py-2 px-4 mt-3 rounded items-center'>
            Request Funds
          </button>
          </div>
          </form> 
