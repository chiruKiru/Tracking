...
export default ({
  ...
  const onSubmitHandler = async (event) => {
    ...
    event.target.name == "image"? setRequest({ ...request, Id_proof: result.path}):
  ...
  return (
          ...
          <p align='left'> Upload a Govt verified file </p>
              {ipfs && ( 
                    <input type="file" className={mass} name="image" onChange={onSubmitHandler}  disabled={request.file != "" ? true : false}/>
              )}
                {request.file != '' ?(
