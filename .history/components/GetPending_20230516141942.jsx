      ...
      <div className="fixed inset-0 w-full h-full bg-black opacity-40" onClick={()=> setRejectFund(false)}>
        ...
        <div className="flex items-center min-h-screen px-4 py-8">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <button onClick={()=> state} className="flex items-center justify-center gap-x-1 py-2 px-4 text-white fot-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900
