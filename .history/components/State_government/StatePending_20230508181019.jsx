import StateApprove from './StateApprove'
export default ({setcreateShipmentModel, allShipmentsdata,getModel, setGetModel, getFund}) =>{
            ...
            {<tbody className="text-gray-600 divide-y">
              {allShipmentsdata?.map((shipment, idx) => (
                ...
                <tr key={idx}>
                  ...
                  rounded-full md:inline-flex"  onClick={()=> setGetModel(false)}>
                   View
                  </button>
