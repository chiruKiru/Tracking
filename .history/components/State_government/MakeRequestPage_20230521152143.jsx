...
export default ({
  ...
  return (
    <>
          ...
          <div><input type="reset" value="Reset Form"/></divu>
          {request.image != '' ? (
          ...
          ):(<button onClick={()=> form.reset()} className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-indigo-600
          hover:bg-indigo-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2'>
            Request Funds
          </button>)
          }
