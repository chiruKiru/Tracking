...
export default ({
  ...
  const [clear, setRequest] = useState({
    receiver:"",
    ReqDate: "",
    from:"",
    amount:"",
  ...
  return (
    <>
          ...
          {request.image != '' ? (
          <button onClick={()=>createItem()}  {...success == true ? form.clear():('')}className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-indigo-600
