...
export default() => {
  ...
  return (
    <nav className={`bg-sky-500/50 w-screen overflow:hid md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0 ": " "}`}>
