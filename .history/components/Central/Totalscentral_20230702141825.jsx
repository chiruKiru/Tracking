...
const TotalsCentral = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{ const result = await web3.eth.getBalance(accounts[0])
            setCurrentbalance(result);
            setCurrentUser(accounts[0]);}</h5>
