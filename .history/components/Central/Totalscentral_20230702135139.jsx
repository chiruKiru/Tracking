...
const TotalsCentral = () => {
  ...
  return (
    ...
    <p className="text-[15px] text-gray-600">
            ...
            <> hi : {allmaindata?.[0]} </>
             <> CentralApproved : {allmaindata?.[1]}</> 
              <> CentralRejected {allmaindata?.[2]}</> 
              <> TotalRequest  {allmaindata?.[3]}</> 
              <> ToatlRejected  {allmaindata?.[4]}</> 
              <> CentralRequest  {allmaindata?.[5]}</> 
              <> CentralTotal {allmaindata?.[4]}</>
            </p>
