...
const TotalsCentral = () => {
  ...
  <> hi : {alldata[0].toNumber()} </>
   <> CentralApproved : {allmaindata[0]}</> 
    <> CentralRejected {allmaindata[1].toNumber()}</> 
    <> TotalRequest  {allmaindata[2].toNumber()}</> 
    <> ToatlRejected  {allmaindata[3].toNumber()}</> 
    <> CentralRequest  {allmaindata[4].toNumber()}</> 
    <> CentralTotal {allmaindata[5].toNumber()}</>
  </p>
