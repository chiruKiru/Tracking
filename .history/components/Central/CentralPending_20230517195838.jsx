...
export default ({getFund,allShipmentsdata,RejectedFund,completeModel, setCompleteModel,centralFund}) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="fixed inset-0 w-full h-full bg-black opacity-40" onClick={()=> set(false)}>
        </div>
        <div className="flex items-center min-h-screen px-4 py-8">
          ...
          <button onClick={()=> {setRejectFund(true); setCompletePay(false);}} className='block w-full mt-3 py-4 font-medium text-sm text-center text-white bg-red-600
      ...
      {<tbody className="text-gray-600 divide-y">
        {allShipmentsdata?.map((shipment, idx) => (
          ...
          <tr key={idx}>
            ...
            rounded-full md:inline-flex" onClick={() =>{setCompleteModel(true); setIndex(idx); getShipmentData(); setGetProduct({
              ...getProduct,
