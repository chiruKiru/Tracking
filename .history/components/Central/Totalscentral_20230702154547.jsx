...
const TotalsCentral = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{balance == undefined ? ("No wallet connected"): (balance.slice(0,4).balance.slice(5,4))}</h5>
