...
export default ({getModel,setGetModel,alldata,RejectedFund,centralFund,getFundMain}) => {
  ...
  const getData = async (idx) => {
    ...
    getData? setGetModel(true) : showAlertFailed
  };
      ...
      {<tbody className="text-gray-600 divide-y">
        {alldata?.map((fund, idx) => (
          fund.status == 1 ?(
            ...
            rounded-full md:inline-flex" onClick={() =>{setGetModel(true); getData(idx); setCompletePay(
              {...completePay,
