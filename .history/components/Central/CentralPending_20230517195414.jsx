...
export default ({getModel,setGetModel, getFund,allShipmentsdata,startFund,RejectedFund,completeModel, setCompleteModel,centralFund}) => {

    const [completepay , setCompleteShip] = useState({
        receiver: "",
        index: "",
        price: ""
      });
