...
export default() => {
  ...
  return (
    <nav className={`bg-gradient-to-r from-violet-500 to-fuchsia-500pb-5 md:text-sm ${state ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0 ": " "}`}>
