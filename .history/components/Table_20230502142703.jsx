    ...
    <div className="mx-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        ...
        <div className="mt-3 md:mt-0">
          ...
          className="inline-block px-4 py-2 text-white duration-1150 font-medium bg-gray-800 hover:bg-gray-700
      ...
      <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
        <table className="w-full table-auto text-sm text-left">
          ...
          <body className="text-gray-600 divide-y">
            {allShipmentsdata?.map((shipment, idx) => (
              <tr key={idx}>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {shipment.status == 0 ? 'Pending' : shipment.status == 1 ? 'In Transit' : ''}
                </td>
              </tr>
            ))}
          </body>
