...
export default ({getModel, setGetModel, getFund,allShipmentsdata,startModel,setStartModel,startFund}) => {
  ...
  const {receiver,index1} = getProduct
    console.log(receiver,index1)
  const startShipping = () => {
      ...
      {<tbody className="text-gray-600 divide-y">
        {allShipmentsdata?.map((shipment, idx) => (
          ...
          <tr key={idx}>
            ...
            rounded-full md:inline-flex" onClick={() =>{setGetModel(true); setIndex(idx); getShipmentData(); setGetProduct(shipment.receiver,idx)}}>
             View
            </button>
