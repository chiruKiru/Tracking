    ...
    const createFund = async (items) => {
        ...
        const TotalValues = async () => {
            try {
                ...
                const CentralRejected = Transaction[0].toNumber();
                const TotalRequest = Transaction[0].toNumber();
                const ToatlRejected = Transaction[0].toNumber(,
                const CentralRequest = Transaction[0].toNumber(),
                const CentralTotal = Transaction[0].toNumber()
