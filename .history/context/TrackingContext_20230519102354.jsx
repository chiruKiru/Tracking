    ...
    const createFund = async (items) => {
        ...
        const getAllTransaction = async () => {
            ...
            try {
                ...
                const allTransaction =                 const Tranc = await contract.getAllTransactions();
                .map((Transaction) => ({
                    index: index+1,
                    sender: Transaction.sender,
                    receiver: Transaction.receiver,
                    price: ethers.utils.formatEther(Transaction.price.toString()),
                    pickupTime: Transaction.pickupTime.toNumber(),
                    deliveryTime: Transaction.deliveryTime.toNumber(),
                    distance:Transaction.distance.toNumber(),
