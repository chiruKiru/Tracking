        ...
        const TotalValues = async () => {
            try {
                ...
                const values = Tranc.map((Transaction) => ({
                    ...
                    CentralRejected: Transaction.CentralApproved.toNumber(),
                    TotalRequest: Transaction.CentralApproved.toNumber(),
                    ToatlRejected: Transaction.CentralApproved.toNumber(),
                    CentralRequest: Transaction.CentralApproved.toNumber(),
                    CentralTotal: Transaction.CentralApproved.toNumber()
                }));
