...
contract Tracking{
    ...
    function getFund(address _sender,uint256 _index) public view returns (address , address,uint256,uint256, uint256 ,uint256,string memory ,string  FundStatus, bool){
        Fund storage fund = funds[_sender][_index];
