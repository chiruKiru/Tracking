...
contract Tracking{
    ...
    event FundCreated(address indexed sender, address indexed receiver, uint256 req_date, uint256 from, uint256 amount,address image);
    ...
    function createFund(address _receiver, uint256 _req_date, uint256 _from, uint256 _amount,address image,) public {
