...
contract Tracking{
    ...
    event FundRejected(address indexed sender, address indexed receiver,string indexed feedback);
    ...
    function RejectedFund(address _sender,address _receiver, uint256 _index, string memory _feedback) public {
        Fund storage fund = funds[_sender][_index];
        TypeFund storage typeFund = typeFunds[_index];
