...
contract Tracking{
    ...
    function startFund(address _sender,address _receiver, uint256 _index) public  view returns (address , address,uint256,uint256, uint256 ,uint256, FundStatus, bool){
